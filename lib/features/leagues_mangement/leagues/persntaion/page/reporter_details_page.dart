...
import '../../../home/presntation/widgets/news_details_media_slider_widget.dart';
import '../riverpod/riverpod.dart';

class ReporterDetailsPage extends ConsumerWidget {
  final int id;

  const ReporterDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(reporterDetailsProvider(id));
    ...
    return Scaffold(
      body: SafeArea(
        ...
        child: CheckStateInGetApiDataWidget(
          state: state,
          refresh: () => ref.invalidate(reporterDetailsProvider(id)),
